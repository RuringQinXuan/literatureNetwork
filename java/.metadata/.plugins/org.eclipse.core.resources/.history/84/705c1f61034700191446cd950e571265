...
public class BuildNetworkTask extends AbstractTask implements ObservableTask{
	...
	public BuildNetworkTask(List<String> documents,List<String> entities){
	...
	public void run(TaskMonitor monitor) throws Exception {
		...
		System.out.println("documents="+query_documents+"&entities="+query_entities);
		...
		JSONObject result = HttpUtils.postJSON("http://localhost:9000/getdata",
				args1);
